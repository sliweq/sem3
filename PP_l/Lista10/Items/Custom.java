...
public class Custom extends Shape {
    ...
    private void generatePoints(int sides){
        ...
        points.add(new Point(getPoint().getX(),getPoint().getY()));
    ...
    public Point[] getBoundingBox() {
        ...
        return new Point[]{new Point(minX,minY),new Point(maxX,minY),new Point(minX,maxY),new Point(maxX,maxY)};
    }
}
